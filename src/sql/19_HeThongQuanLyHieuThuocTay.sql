...
VALUES
('NV001', N'Nguyễn', N'Văn An', null, '1990-05-10', '0123456789', N'123 Le Loi, TP.HCM', 1, 1, 1),
('NV002', N'Trần', N'Thị Bình', null , '1992-07-20', '0987654321', N'456 Tran Hung Dao, TP.HCM', 0, 1, 1),
('NV003', N'Lê', N'Văn Cao', null , '1988-03-15', '0456789123', N'789 Nguyen Trai, TP.HCM', 1, 1, 1),
('QL001', N'Cao', N'Thành Đông', null , '1995-08-25', '321654987', N'321 Hai Ba Trung, TP.HCM', 1, 2, 1),
('QL002', N'Võ', N'Thị Dung', null , '1985-12-11', '0789123456', N'654 Cong Quynh, TP.HCM', 0, 2, 1),
...
VALUES
('KH001', N'Lê', N'Thanh', '1991-04-10', 0, N'23 Nguyen Hue, TP.HCM', '0123456789', 1, 'DTL001'),
('KH002', N'Phạm', N'Khánh Vân', '1980-11-22', 0, N'45 Dien Bien Phu, TP.HCM', '0123456788', 1, 'DTL002'),
('KH003', N'Trần', N'Quốc Anh', '1993-02-18', 1, N'67 Phan Xich Long, TP.HCM', '0123456787', 1, 'DTL003'),
('KH004', N'Nguyễn', N'Văn Hải', '1996-09-07', 1, N'89 Ton Duc Thang, TP.HCM', '0123456786', 1, 'DTL004'),
('KH005', N'Hồ', N'Văn Minh', '1989-06-30', 1, N'12 Tran Cao Van, TP.HCM', '0123456785', 1, 'DTL005')


-- Bảng NhaCungCap
INSERT INTO NhaCungCap (maNCC, tenNCC, diaChi, email)
VALUES
('NCC001', N'Công ty Cổ phần Dược Hậu Giang', N'288 Bis Nguyễn Văn Cừ, P. An Hòa, Q. Ninh Kiều, TP. Cần Thơ', 'dhgpharma@dhgpharma.com.vn'),
('NCC002', N'Công ty Cổ phần Traphaco', N'75 Yên Ninh, Ba Đình, Hà Nội, Việt Nam', 'info@traphaco.com.vn'),
('NCC003', N'Công ty Cổ phần Dược phẩm Imexpharm', N'Số 4, Đường 30/4, Phường 1, TP Cao Lãnh, Đồng Tháp', 'vandt@imexpharm.com'),
('NCC004', N'Công ty Cổ phần Dược phẩm Pymepharco', N'166 – 170 Nguyễn Huệ,Phường 7, Tp.Tuy Hòa, Phú Yên', 'pymepharco.office@stada.com'),
('NCC005', N'Công ty Cổ phần Dược phẩm OPC', N'1017 Hồng Bàng, Phường 12, Quận 6, TP. Hồ Chí Minh', 'info@opcpharma.com')
...
VALUES
('NSX001', N'Công ty Cổ phần Dược Hậu Giang', '288 Bis Nguyễn Văn Cừ, P. An Hòa, Q. Ninh Kiều, TP. Cần Thơ'),
('NSX002', N'Công ty Cổ phần Traphaco', '75 Yên Ninh, Ba Đình, Hà Nội, Việt Nam'),
('NSX003', N'Công ty Cổ phần Dược phẩm Imexpharm', 'Số 4, Đường 30/4, Phường 1, TP Cao Lãnh, Đồng Tháp'),
('NSX004', N'Công ty Cổ phần Dược phẩm Pymepharco', '166 – 170 Nguyễn Huệ,Phường 7, Tp.Tuy Hòa, Phú Yên'),
('NSX005', N'Công ty Cổ phần Dược phẩm OPC', '1017 Hồng Bàng, Phường 12, Quận 6, TP. Hồ Chí Minh')
...
VALUES
('LO001', 'PN001', '2022-10-10', 3000000),
('LO002', 'PN002', '2022-10-11', 4000000),
('LO003', 'PN003', '2024-11-12', 5000000),
('LO004', 'PN003', '2024-11-12', 5000000),
('LO005', 'PN003', '2024-11-12', 5000000),
('LO006', 'PN003', '2024-12-12', 5000000),
('LO007', 'PN003', '2024-12-12', 5000000),
('LO008', 'PN003', '2024-12-12', 5000000),
('LO009', 'PN003', '2024-12-12', 5000000)

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH001', 'T001', 'LO001', 50, 'DG001', '2022-1-1', '2023-12-1'),
('SH002', 'T002', 'LO001', 40, 'DG002', '2022-1-1', '2023-7-1'),
('SH003', 'T003', 'LO003', 50, 'DG003', '2024-1-1', '2025-8-1'),
('SH004', 'T004', 'LO002', 50, 'DG004', '2022-1-1', '2023-3-1'),
('SH005', 'T005', 'LO002', 300, 'DG005', '2022-1-1', '2023-12-1'),
('SH006', 'T005', 'LO002', 20, 'DG006', '2022-1-1', '2023-1-1')

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH007', 'T006', 'LO003', 50, 'DG007', '2024-1-1', '2025-12-1'),
('SH008', 'T007', 'LO002', 40, 'DG008', '2022-1-1', '2025-1-1'),
('SH009', 'T008', 'LO003', 50, 'DG009', '2024-1-1', '2025-12-1'),
('SH010', 'T009', 'LO002', 50, 'DG010', '2022-1-1', '2025-1-1'),
('SH011', 'T010', 'LO002', 300, 'DG011', '2022-1-1', '2025-1-1')

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH012', 'T001', 'LO004', 50, 'DG001', '2024-1-1', '2025-12-30'),
('SH013', 'T002', 'LO004', 40, 'DG002', '2024-1-1', '2025-12-1'),
('SH014', 'T003', 'LO004', 50, 'DG003', '2024-1-1', '2025-12-1'),
('SH015', 'T004', 'LO004', 50, 'DG004', '2024-1-1', '2025-12-1'),
('SH016', 'T005', 'LO004', 300, 'DG005', '2024-1-1', '2025-12-1')

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH017', 'T006', 'LO005', 50, 'DG007', '2024-1-1', '2024-12-30'),
('SH018', 'T007', 'LO005', 40, 'DG008', '2024-1-1', '2025-12-1'),
('SH019', 'T008', 'LO005', 50, 'DG009', '2024-1-1', '2025-12-1'),
('SH020', 'T009', 'LO005', 50, 'DG010', '2024-1-1', '2025-12-1'),
('SH021', 'T010', 'LO005', 300, 'DG011', '2024-1-1', '2025-12-1')

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH022', 'T001', 'LO006', 50, 'DG001', '2024-1-1', '2025-12-30'),
('SH023', 'T002', 'LO006', 40, 'DG002', '2024-1-1', '2025-12-1'),
('SH024', 'T003', 'LO006', 50, 'DG003', '2024-1-1', '2024-12-1'),
('SH025', 'T004', 'LO006', 50, 'DG004', '2024-1-1', '2025-12-1'),
('SH026', 'T005', 'LO006', 300, 'DG005', '2024-1-1', '2025-12-1')

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH027', 'T006', 'LO007', 50, 'DG007', '2024-1-1', '2025-12-30'),
('SH028', 'T007', 'LO007', 40, 'DG008', '2024-1-1', '2025-12-1'),
('SH029', 'T008', 'LO007', 50, 'DG009', '2024-1-1', '2025-12-1'),
('SH030', 'T009', 'LO007', 50, 'DG010', '2024-1-1', '2024-12-1'),
('SH031', 'T010', 'LO007', 300, 'DG011', '2024-1-1', '2025-12-1')

INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH032', 'T001', 'LO008', 50, 'DG001', '2024-1-1', '2025-12-30'),
('SH033', 'T002', 'LO008', 40, 'DG002', '2024-1-1', '2025-12-1'),
('SH034', 'T003', 'LO008', 50, 'DG003', '2024-1-1', '2025-12-1'),
('SH035', 'T004', 'LO008', 50, 'DG004', '2024-1-1', '2024-12-1'),
('SH036', 'T005', 'LO008', 300, 'DG005', '2024-1-1', '2024-12-1')


INSERT INTO ChiTietLoThuoc(soHieuThuoc, maThuoc, maLoThuoc, soLuongCon, maDonGia, ngaySX, HSD)
VALUES
('SH037', 'T006', 'LO009', 50, 'DG007', '2024-1-1', '2024-12-30'),
('SH038', 'T007', 'LO009', 40, 'DG008', '2024-1-1', '2025-12-1'),
('SH039', 'T008', 'LO009', 50, 'DG009', '2024-1-1', '2025-12-1'),
('SH040', 'T009', 'LO009', 50, 'DG010', '2024-1-1', '2024-12-30'),
('SH041', 'T010', 'LO009', 300, 'DG011', '2024-1-1', '2024-12-1')

-- Bảng HoaDon
INSERT INTO HoaDon (maHD, maKhachHang, maNhanVien, maThue, ngayLap, hinhThucThanhToan, tongTien, trangThai)
VALUES
('HD001', 'KH001', 'NV001', 'THUE001', '2024-03-01', N'Tiền mặt', 187000, 1),
('HD002', 'KH002', 'NV002', 'THUE001', '2024-09-02', N'Tiền mặt', 357500, 1),
('HD003', 'KH003', 'NV002', 'THUE001', '2024-11-05', N'Tiền mặt', 357500, 1),
('HD004', 'KH004', 'NV002', 'THUE001', '2024-03-02', N'Tiền mặt', 50000, 1),
('HD005', 'KH005', 'NV002', 'THUE001', '2024-09-02', N'Tiền mặt', 404500, 1),
('HD006', 'KH003', 'NV002', 'THUE001', '2024-12-02', N'Tiền mặt', 123500, 1),
('HD007', 'KH004', 'NV002', 'THUE001', '2024-12-11', N'Tiền mặt', 124500, 1),
('HD008', 'KH005', 'NV002', 'THUE001', '2024-12-11', N'Tiền mặt', 623500, 1)
...
('HD003', 'SH005', 'T005', N'Viên', 5, 100000),
('HD003', 'SH006', 'T005', N'Hộp', 5, 210000),
('HD004', 'SH007', 'T006', N'Hộp', 5, 130000),
('HD005', 'SH008', 'T007', N'Hộp', 6, 530000),
('HD005', 'SH009', 'T008', N'Hộp', 5, 123000),
('HD005', 'SH010', 'T009', N'Hộp', 10, 430000),
('HD005', 'SH011', 'T010', N'Viên', 5, 100000),
('HD006', 'SH012', 'T001', N'Hộp', 5, 210000),
('HD006', 'SH013', 'T002', N'Hộp', 8, 400000),
('HD007', 'SH014', 'T003', N'Hộp', 6, 231000),
('HD007', 'SH015', 'T004', N'Hộp', 5, 100000),
('HD007', 'SH016', 'T005', N'Viên', 2, 100000),
('HD008', 'SH017', 'T006', N'Hộp', 3, 70000),
('HD008', 'SH018', 'T007', N'Hộp', 5, 150000),
('HD008', 'SH019', 'T008', N'Hộp', 2, 50000),
('HD008', 'SH020', 'T009', N'Hộp', 5, 120000)

---- Bảng DonDatThuoc
INSERT INTO DonDatThuoc (maDon, maKhachHang, maNhanVien, thoiGianDat, tongTien)
VALUES
('MD001', 'KH001', 'NV001', '2024-12-12', 85000),
('MD002', 'KH002', 'NV002', '2024-12-12', 300000),
('MD003', 'KH003', 'NV003', '2024-12-12', 250000),
('MD004', 'KH004', 'NV001', '2024-12-12', 300000)
...
('MD004', 'SH003', 'T003', N'Hộp', 1, 150000),
('MD004', 'SH004', 'T004', N'Hộp', 2, 150000)
